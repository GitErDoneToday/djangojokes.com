...
SECRET_KEY = '03jj$*h6n@^rmz87jn4=$9$%yr*%-3(ll52m%+$n_mnnll76se'
...
DEFAULT_FROM_EMAIL = 'swithrow@webucator.com'
...
AUTHENTICATION_BACKENDS = (
    # Needed to login by username in Django admin, w/o `allauth`
...
AWS_STORAGE_BUCKET_NAME = 'heroku-django-jokes-app-swithrow' # REPLACE WITH YOUR BUCKET NAME
